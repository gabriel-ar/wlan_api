...
namespace WlanApi {
    ...
    public static class Wlan {
        ...
        public enum WlanNotificationSource {
            ...
            IHV = 0X00000040,
            /// <summary>
            /// Notifications generated by Hosted Network (HNWK).
            /// </summary>
            HNWK = 0X00000080,
        ...
        public struct WlanNotificationData {
            ...
            public object NotificationCode {
                get {
                    ...
                    else if(notificationSource == WlanNotificationSource.HNWK)
                        return (HostedNetworkNotificationCode) notificationCode;
                    else
        ...
        public enum WlanReasonCode {
            ...
            IHV_CONNECTIVITY_NOT_SUPPORTED = ( PROFILE_BASE + 21 ),
            BAD_MAX_NUMBER_OF_CLIENTS_FOR_AP = ( PROFILE_BASE + 22 ),
            INVALID_CHANNEL = ( PROFILE_BASE + 23 ),
            OPERATION_MODE_NOT_SUPPORTED = ( PROFILE_BASE + 24 ),
            AUTO_AP_PROFILE_NOT_ALLOWED = ( PROFILE_BASE + 25 ),
            AUTO_CONNECTION_NOT_ALLOWED = ( PROFILE_BASE + 26 ),
            ...
            // Failed to start AP
            AP_STARTING_FAILURE = ( MSM_CONNECT_BASE + 19 ),
            ...
            MSMSEC_PROFILE_SAFE_MODE = ( MSMSEC_BASE + 32 ),
            // Profile requires safe mode, not supported by NIC
            MSMSEC_CAPABILITY_PROFILE_SAFE_MODE_NIC = ( MSMSEC_BASE + 33 ),
            // Profile requires safe mode, not supported by network
            MSMSEC_CAPABILITY_PROFILE_SAFE_MODE_NW = ( MSMSEC_BASE + 34 ),
            // Profile has unsupported auth
            MSMSEC_PROFILE_UNSUPPORTED_AUTH = ( MSMSEC_BASE + 35 ),
            // Profile has unsupported cipher
            SMSEC_PROFILE_UNSUPPORTED_CIPHER = ( MSMSEC_BASE + 36 ),
        ...
        //TODO: Buscar mejor forma de Marshalizar un array
        [StructLayout(LayoutKind.Sequential)]
        public struct WlanHostedNetworkStatus {
            ...
            public WlanHostedNetworkPeerState[] peer_list;
            }
        ...
        public static extern int WlanHostedNetworkQuerySecondaryKey(
           [In] IntPtr clientHandle,
           [Out] out uint dwKeyLength,
           [Out] out IntPtr data,
           [Out] out bool IsPassPhrase,
           [Out] out bool Persistent,
           [Out] out HostedNetworkReason FailReason,
           IntPtr reservedPtr);
        ...
        public class ArrayMarshaler<T>:ICustomMarshaler {
            ...
            public IntPtr MarshalManagedToNative(Object ManagedObject) {
                ...
                for(int i = 0; i < array.Length; i++) {   // Newly-allocated space has no existing object, so the last param is false
